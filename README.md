...
1. Message Authentication Code (MAC) is a# EX-NO-13-MESSAGE-AUTHENTICATION-CODE-MAC
...
The program is executed successfully.
 cryptographic technique used to verify the integrity and authenticity of a message by using a secret key.
